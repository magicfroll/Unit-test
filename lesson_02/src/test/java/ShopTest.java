...
*/
    ...
    void priceCartIsCorrectCalculated() {
        ...
        cart.addProductToCartByID(2); // 170 +
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        cart.addProductToCartByID(3); // 170 +
        // Assert
        assertThat(cart.getTotalPrice()).isEqualTo(990);
    }
    ...
    void incorrectProductSelectionCausesException(int ids) {
        Shop shop = new Shop(getStoreItems());
        Cart cart = new Cart(shop);
        assertThatThrownBy(() -> {shop.getProductsShop().get(ids);}).isInstanceOf(RuntimeException.class);
    }
