...
//        assertThat(Calculator.squareRootExtraction(1)).isEqualTo(1.0);
//        assertThatThrownBy(() ->
...
//            assertThat(Calculator.calculation(2, 6, '+')).isEqualTo(0);
        ...
        // HW1.3: Проверить метод calculateDiscount с использованием библиотеки AsserJ
//        assertThat(Calculator.calculatingDiscount(100, 5)).isEqualTo(95);
//        assertThatThrownBy(() -> Calculator.calculatingDiscount(100, -50)
//        ).isInstanceOf(ArithmeticException.class);
